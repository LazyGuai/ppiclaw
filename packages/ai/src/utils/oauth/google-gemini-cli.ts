...
const CLIENT_ID = process.env.PI_GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID;
const CLIENT_SECRET = process.env.PI_GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET;
...
function assertOAuthClientConfigured(): { clientId: string; clientSecret: string } {
	if (!CLIENT_ID || !CLIENT_SECRET) {
		throw new Error(
			[
				"Google Gemini CLI OAuth client is not configured.",
				"Set PI_GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID and PI_GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET in your environment.",
			].join(" "),
		);
	}
